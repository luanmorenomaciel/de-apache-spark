...
if __name__ == '__main__':
    ...
    get_users_file = "s3://owshq-processing-zone/files/users/*.json"
    get_business_file = "s3://owshq-processing-zone/files/business/*.json"
    get_reviews_file = "s3://owshq-processing-zone/files/reviews/*.json"
