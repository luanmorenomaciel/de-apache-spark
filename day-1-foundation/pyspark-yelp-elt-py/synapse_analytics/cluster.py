...
if __name__ == '__main__':
    ...
    get_users_file = "abfs://processing@owshqcatalogsynapse.dfs.core.windows.net/users/*.json"
    get_business_file = "abfs://processing@owshqcatalogsynapse.dfs.core.windows.net/business/*.json"
    get_reviews_file = "abfs://processing@owshqcatalogsynapse.dfs.core.windows.net/reviews/*.json"
